...
public class MainBedroom extends RoomApplication {
	...
	public void addSwitchingList() {
		switchingList.add(new NameAndURL("main bedroom switch 1",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/REGULAR/switch1"));
		switchingList.add(new NameAndURL(" main bedroom switch 2",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/REGULAR/switch2"));
		switchingList.add(new NameAndURL("main bedroom  switch 3",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/REGULAR/switch3"));
	...
	public void addBrightnessList() {
		brightnessList.add(new NameAndURL("main bedroom  brightness 1",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/PWM/ceilingLight1"));
		brightnessList.add(new NameAndURL("main bedroom brightness 2",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/PWM/ceilingLight2"));
		brightnessList.add(new NameAndURL("main bedroom brightness 3",
				Constants.MAIN_BEDROOM_URL + Constants.LIGHT
						+ "/PWM/ceilingLight3"));
